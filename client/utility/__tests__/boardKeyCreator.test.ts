...
test('default arguments creates correct boardKey with mocked Math.random so that red is the first team', () => {
...
test('default arguments creates correct boardKey with mocked Math.random so that blue is the first team', () => {
